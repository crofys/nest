 ...
 * @LastEditTime: 2019-11-29 18:22:02
 * @LastEditors: 徐长剑
 */
...
export abstract class ICurdService<T = any> {
  ...
  abstract update(id: ObjectID, param: T): Promise<void>;
  abstract delete(id: ObjectID): Promise<void>;
  abstract findOneById(id: ObjectID): Promise<T>;
}
