 ...
 * @LastEditTime: 2019-11-28 19:05:57
 * @LastEditors: 徐长剑
 */
...
export const CurdController = service => {
  return class CurdController {
    constructor(@Inject(service) private readonly postService: service) {}
    /**
     * 查询
